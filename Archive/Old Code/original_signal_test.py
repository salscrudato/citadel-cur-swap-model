...
# Define half-life lookback ---------- Replace with for loop for final implementation
hl_lookback = 63
hl_lookback_tot = 42
hl_lookback_3m2y = 504
hl_lookback_fx = 84
hl_lookback_msci = 84
hl_lookback_iv = 252
hl_smooth = 5
...
output_file = f'CNR/cnr_smooth_{hl_smooth}_hl_{hl_lookback_cnr}.csv'
